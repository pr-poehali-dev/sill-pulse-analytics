...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
              ...
              >
                <CardContent className="pt-6 space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-bold text-[#072A4A]">{testimonial.name}</div>
      ...
      <section id="business" className="py-20 bg-gradient-to-br from-[#072A4A] to-[#0a3d5f] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4 group">
                    <div className="w-12 h-12 rounded-lg bg-[#20B0B4]/20 flex items-center justify-center flex-shrink-0 group-hover:bg-[#20B0B4]/30 transition-colors">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button size="lg" className="bg-[#20B0B4] hover:bg-[#20B0B4]/90" onClick={() => navigate('/business')}>
              ...
              <Card className="bg-white/10 backdrop-blur-lg border-white/20">
                <CardContent className="pt-6 space-y-6">
                  <div className="text-center space-y-2">
                    <div className="text-5xl font-bold text-[#20B0B4]">Корпоративный</div>
                    <div className="text-gray-300">От ₽49,990/мес</div>
                  </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8 border-2 border-gray-300">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    <div className="font-bold text-lg text-[#072A4A]">Тота ИИ</div>
                    <div className="text-sm text-gray-600">Онлайн • Готов помочь</div>
                  </div>
                </div>

                <div className="space-y-4">
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <p className="text-sm text-gray-500 mb-2">Вы:</p>
                    <p className="text-[#072A4A]">Какие навыки нужны для Frontend разработчика?</p>
                  </div>

                  <div className="bg-[#20B0B4]/10 rounded-lg p-4 border border-[#20B0B4]/30">
                    <p className="text-sm text-[#20B0B4] mb-2">Тота ИИ:</p>
                    <p className="text-[#072A4A]">На основе анализа 1,247 вакансий, топ-5 навыков:</p>
                    <div className="flex flex-wrap gap-2 mt-3">
                      {['React', 'TypeScript', 'CSS', 'Git', 'REST API'].map((skill, i) => (
                        <Badge key={i} className="bg-white text-[#072A4A] border-[#20B0B4]">
                          {skill}
                        </Badge>
                      ))}
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 pt-4">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4 group">
                    <div className="w-10 h-10 rounded-lg bg-[#20B0B4]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#20B0B4]/20 transition-colors">
                      <Icon name={item.icon as any} size={20} className="text-[#20B0B4]" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-[#072A4A] mb-1">{item.title}</h4>
              ...
              <Button size="lg" className="bg-[#20B0B4] hover:bg-[#20B0B4]/90 text-lg px-8" onClick={() => navigate('/ai-assistant')}>
      ...
      <section id="blog" className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <Button size="lg" className="bg-[#20B0B4] hover:bg-[#20B0B4]/90" onClick={() => navigate('/blog')}>
              Все статьи блога
              <Icon name="ArrowRight" size={16} className="ml-2" />
            </Button>
          </div>
